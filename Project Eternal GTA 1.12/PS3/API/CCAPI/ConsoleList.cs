...
namespace PS3Lib
{
    public class ConsoleList
    {
        ...
        public bool Show()
        {
            ...
            SimpleButton btnConnect = new SimpleButton();
            ...
            XtraForm formList = new XtraForm();
            formList.Opacity = 0.82D;
            formList.BackColor = Color.Black;
            formList.ForeColor = Color.FromArgb(240, 240, 240);
            ...
            btnConnect.Click += (sender, e) =>
            {
                if (tNum > -1)
                {
                    ...
                    XtraMessageBox.Show(strTraduction("errorSelect"), strTraduction("errorSelectTitle"), MessageBoxButtons.OK, MessageBoxIcon.Error);
            };
            ...
            else
            {
                Result = false;
                formList.Close();
                XtraMessageBox.Show(strTraduction("noConsole"), strTraduction("noConsoleTitle"), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }

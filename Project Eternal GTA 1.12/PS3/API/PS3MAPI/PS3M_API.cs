...
namespace PS3Lib
{
    public class PS3MAPI
    {
        ...
        public bool GetProcessList(out uint[] pids)
        {
            ...
            {
                XtraMessageBox.Show(ex.Message, "Error PS3M_API", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        ...
        public bool SetConsoleID(string consoleID)
        {
            ...
            {
                XtraMessageBox.Show("Invalid ConsoleID", "Error PS3M_API", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            try
            {
